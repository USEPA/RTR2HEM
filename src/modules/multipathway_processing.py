import pandas as pd
from src.modules.queries.latitudes_longitudes import LatLons
from src.modules.queries.HH import run_HH_module
from src.modules.queries.Eco import run_Eco_module
